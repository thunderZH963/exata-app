...
//---------------------------------------------------------------------------
// FUNCTION             : IO_ReadBoolInstance
// PURPOSE             :: Reads BOOL value for specified IPv6 address.
// PARAMETERS          :
// +nodeId             :const NodeId nodeId :: NodeId for which parameter has
//                                 has to be searched.
// +interfaceAddress  : const in6_addr* interfaceAddress ::
...
// +parameterValue    : BOOL *parameterValue :: Parameter's value if found.
// RETURN             : None
// NOTE:
// Overloaded API IO_ReadBoolInstance()
// -----------------------------------------------------------------------------
...
// /**
// API :: IO_ReadChannelMask
// PURPOSE :: This API is used to retrieve the value channel mask
//            for a specific instance.
// PARAMETERS ::
// + node                      : Node*             : node structure pointer.
// + nodeId                    : const NodeAddress : nodeId.
// + address                   : const Address*    : Pointer to address
//                                                   structure.
// + interfaceIndex            : int               : interface Index.
// + nodeInput                 : const NodeInput*  : Pointer to node input.
// + parameterName             : const char*       : Parameter name.
...
//                                            cannot be matched.
// + wasFound                  : BOOL*      : Storage for success of search.
// + parseChannelList          : BOOL*      : Storage for identifying if
...
//---------------------------------------------------------------------------
// FUNCTION                     :: IO_GetMatchType
// PURPOSE                      :: Sets matchType to the value of the best match
// PARAMETERS                   ::
// +nodeId                      : const NodeAddress : NodeId for
//                                which parameter has to be searched.
// +address                     : const Address* : Pointer to address
//                                structure. address can have ip v4 or v6 address
// +nodeInput                   : const NodeInput* : pointer to 
//                                configuration inputs
// +parameterName               : const char* : Parameter to be read
// +parameterFound              : BOOL* : Parameter found or not
// +parameterInstanceNumber     : const int : Instance number.
// +matchType                   : int& : Stores the type of the match if 
...
// + parameterValue     : BOOL*             : Storage for parameter value.
// RETURN               : void
// Note : Overloaded API for reading the boolean value based on interfaceIndex.
// **/
void
IO_ReadBool(
    Node* node,
...
// + parameterValue     : float*             : Storage for parameter value.
// RETURN               : void
// Note : Overloaded API for reading the float value based on interfaceIndex.
// **/
void
IO_ReadFloat(
    Node* node,
