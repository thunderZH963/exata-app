...
//  used for module data. For example, PartitionGlobalDataIndex[PartitionGlobalDataJNE]
//  points to a JnePartitionGlobalData structure that stores data related to
//  JNE interfaces and applications.
// **/
enum PartitionGlobalDataIndex
{
    PartitionGlobalDataJNE = 0,
...
public:
    PartitionData(int thePartitionId, int numPartitions);
    ...
    // /**
    // API        :: getGlobalTime
    // PURPOSE    :: Returns the simulation time at a global level
    ...
    // RETURN :: clocktye : The current global simulation time
    // **/
