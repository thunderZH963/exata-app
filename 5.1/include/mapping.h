...
typedef enum
{
    ...
    DEPRECATED,    // depreacated ipv6 address state whose use is discouraged
...
// /**
// API       :: MAPPING_GetNetworkTypeFromInterface
// PURPOSE   :: This function determines the network type of a particular
//              interface of a node
// PARAMETERS::
