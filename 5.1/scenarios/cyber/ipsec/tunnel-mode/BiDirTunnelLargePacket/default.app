...
# EXAMPLE:
#
#       a) LOOKUP 1 2 10 64 2812 1S 0S 0S 10S
#
...
#       packet from node 1.  The size of each reply packet is 2812B.
#       LOOKUP starts at 0 seconds into simulation and stops after 10 seconds
#       into simulation.
#
#       b) LOOKUP 1 2 10 64 2812 1S 1MS 10S 20S
#
#       Node 1 sends to node 2 10 requests of 64B each every 1 second.
...
#       2812B.  LOOKUP starts at 10 seconds into simulation and stops after
...
CBR 1 6 10 2812 1S 5M 0S
CBR 6 1 10 2812 1S 5M 0S
