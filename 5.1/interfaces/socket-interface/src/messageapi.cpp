...
void SocketInterface_CommEffectsRequestMessage::Print(std::string *str)
{
    ...
    sprintf (str2, "CommEffectsRequest: Id1 = %" TYPES_64BITFMT "u", m_Id1);
    *str += str2;

    sprintf (str2, ", Id2 = %" TYPES_64BITFMT "u", m_Id2);
    *str += str2;
...

{
    ...
    sprintf (str2, "CommEffectsResponse: Id1 = %" TYPES_64BITFMT "u",
            m_Id1);
...
SocketInterface_CommEffectsResponseMessage::Serialize()
...

{
    ...
    *scenarioFile = "";
...

    {
        ...
        sprintf(buf, "Can't open input scenario file '%s'", fileName->c_str());
