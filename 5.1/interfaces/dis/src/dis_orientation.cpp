    ...
    short& elevation)
{
    ...
    double elevationRadians
        = (DIS_PI / 2.0) - deflectionFromNormalToSphereRadians;

    elevation = (short) DisRint(elevationRadians * DIS_DEGREES_PER_RADIAN);
    ...
    {
        azimuthRadians = (2.0 * DIS_PI) - azimuthRadians;
    }

    azimuth = (short) DisRint(azimuthRadians * DIS_DEGREES_PER_RADIAN);
