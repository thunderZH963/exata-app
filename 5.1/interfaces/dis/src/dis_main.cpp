...
DisHandleSigInt(int a)
{
    ...
    g_dis.partitionData->maxSimClock = g_dis.partitionData->getGlobalTime();
}
...
{
    clocktype simTime = g_dis.partitionData->getGlobalTime();
    ...
    const DisRadio& radio, bool enableInterface)
{
    ...
    clocktype simTime = radio.node->getNodeTime();
    clocktype delay;
...
DisPrintSentRtssNotification(Node* node)
{
    ...
    TIME_PrintClockInSecond(node->getNodeTime(), clocktypeString);
...
DisProcessCommEffectsRequest(const DisSignalPdu& pdu)
{
    ...
    clocktype simTime = srcNode->getNodeTime();
    clocktype sendTime;
    ...
    const clocktype sendDelay = sendTime - srcNode->getNodeTime();
    ...
    unsigned short success)
{
    ...
    const clocktype delay = node->getNodeTime() - osmInfo.sendTime;
