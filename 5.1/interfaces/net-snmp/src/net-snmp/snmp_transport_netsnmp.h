#ifndef SNMP_TRANSPORT_H_NETSNMP
#define SNMP_TRANSPORT_H_NETSNMP
...
typedef struct netsnmp_transport_s {
    ...
    int             (NetSnmpAgent::*f_recv)   (struct netsnmp_transport_s* , void* ,
                 int, void** , int*);
    int             (NetSnmpAgent::*f_send)   (struct netsnmp_transport_s* , void* ,
                 int, void** , int*);
    int             (NetSnmpAgent::*f_close)  (struct netsnmp_transport_s*);

    /*  This callback is only necessary for stream-oriented transports.  */

    int             (NetSnmpAgent::*f_accept) (struct netsnmp_transport_s*);

    /*  Optional callback to format a transport address.  */

    char*           (NetSnmpAgent::*f_fmtaddr)(struct netsnmp_transport_s* , void* ,
                 int);
} netsnmp_transport;
...
#endif
#endif/*_SNMP_TRANSPORT_H_NETSNMP */
