...
netsnmp_binary_array_initialize(void)
{
    ...
    t = (binary_array_table*) calloc(1, sizeof(binary_array_table));
    if (t == NULL)
        return NULL;
...
netsnmp_binary_array_remove(netsnmp_container* c, const void* key, void** save)
{
     ...
     * search
     */
    if ((index = binary_search(key, c, 1)) == (size_t)-1)
        return -1;
...
_ba_get_subset(netsnmp_container* container, void* data)
{
    ...
    va = (netsnmp_void_array*) calloc(1, sizeof(netsnmp_void_array));
...
netsnmp_container_get_binary_array(void)
{
     ...
     */
    netsnmp_container* c =
        (netsnmp_container*) calloc(1, sizeof(netsnmp_container));
...
void
NetSnmpAgent::netsnmp_container_binary_array_init(void)
{
