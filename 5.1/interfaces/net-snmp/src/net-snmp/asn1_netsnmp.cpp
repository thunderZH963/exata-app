                       ...
                       u_char type, const u_long*  intp, size_t intsize)
{
     ...
     */
    temp = integer & mask;
    if ((u_char) ((temp) >> (8 * (sizeof(long) - 1))) & 0x80) {
        /*
         * if MSB is set
         */
        add_null_byte = 1;
...
u_char*
NetSnmpAgent::asn_build_string(u_char*  data,
                 size_t*  datalength,
                ...
                u_char*  type, float* floatp, size_t floatsize)
{
    ...
    *datalength -= (int) asn_length + (bufp - data);
     ...
     */
    EXTERNAL_ntoh(&fu.longVal, sizeof(fu.longVal));
                ...
                u_char type, const float* floatp, size_t floatsize)
{
    ...
    *datalength = *datalength - 3;
     ...
     * correct for endian differences
     */
    EXTERNAL_hton(&fu.intVal, sizeof(fu.intVal));
                 ...
                 u_char*  type, double* doublep, size_t doublesize)
{
    ...
    *datalength -= (int) asn_length + (bufp - data);
    ...
    tmp = fu.intVal[0];
    EXTERNAL_ntoh(&tmp, sizeof(tmp));
    fu.intVal[0] = fu.intVal[1];
    EXTERNAL_ntoh(&fu.intVal[0], sizeof(fu.intVal[0]));
    fu.intVal[1] = tmp;
                 ...
                 u_char type, const double* doublep, size_t doublesize)
{
    ...
    *datalength = *datalength - 3;
     ...
     */
    tmp = fu.intVal[0];
    EXTERNAL_hton(&tmp, sizeof(tmp));
    fu.intVal[0] = fu.intVal[1];
    EXTERNAL_hton(&fu.intVal[0, sizeof(fu.intVal[0));
    fu.intVal[1] = tmp;
...
int
NetSnmpAgent::asn_realloc_rbuild_string(u_char**  pkt, size_t*  pkt_len,
                          size_t*  offset, int r,
                          u_char type,
 ...
 */
int
NetSnmpAgent::asn_realloc_rbuild_unsigned_int(u_char**  pkt, size_t*  pkt_len,
                                size_t*  offset, int r,
                            u_char type, const u_long*  intp, size_t intsize)
{
    static const char* errpre = "build uint";
...
int
NetSnmpAgent::asn_realloc_rbuild_objid(u_char**  pkt, size_t*  pkt_len,
                         size_t*  offset, int r,
                         u_char type,
...
int
NetSnmpAgent::asn_realloc_rbuild_null(u_char**  pkt, size_t*  pkt_len,
...
int
NetSnmpAgent::asn_realloc_rbuild_bitstring(u_char**  pkt, size_t*  pkt_len,
                             size_t*  offset, int r,
                             u_char type,
                             const u_char*  str, size_t strlength)
{
 ...
 */
int
NetSnmpAgent::asn_realloc_rbuild_unsigned_int64(u_char**  pkt, size_t*  pkt_len,
                                  size_t*  offset, int r,
                                  u_char type,
...
u_char*
NetSnmpAgent::asn_parse_string(u_char*  data,
                 size_t*  datalength,
                 u_char*  type, u_char*  str, size_t*  strlength)
{
    static const char* errpre = "parse string";
    ...
    *datalength -= (int) asn_length + (bufp - data);
    ...
    sprint_realloc_asciistring(&buf, &l, &ol, 1, str, asn_length);
    if (buf != NULL) {
        free(buf);
    }
