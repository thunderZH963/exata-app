                             ...
                             int flags, size_t max_size, size_t* size_p)
{
    netsnmp_watcher_info* winfo =
        (netsnmp_watcher_info*) calloc(1, sizeof(netsnmp_watcher_info));
    if (winfo)
...
int
NetSnmpAgent::netsnmp_register_watched_instance(netsnmp_handler_registration* reginfo,
...
int
NetSnmpAgent::netsnmp_register_watched_scalar(netsnmp_handler_registration* reginfo,
                                  netsnmp_watcher_info*         watchinfo)
{
    netsnmp_mib_handler* whandler;
...
int
NetSnmpAgent::netsnmp_watched_timestamp_register(netsnmp_mib_handler* whandler,
                                   netsnmp_handler_registration* reginfo,
                                   marker_t timestamp)
{
...
int
NetSnmpAgent::netsnmp_register_watched_timestamp(netsnmp_handler_registration* reginfo,
                                   marker_t timestamp)
{
    netsnmp_mib_handler* whandler;
...
int
NetSnmpAgent::netsnmp_register_watched_spinlock(netsnmp_handler_registration* reginfo,
                                   int* spinlock)
{
    netsnmp_mib_handler*  whandler;
    netsnmp_watcher_info* winfo;
...
int
NetSnmpAgent::netsnmp_register_ulong_scalar(const char* name,
...
int
NetSnmpAgent::netsnmp_register_read_only_ulong_scalar(const char* name,
                              const oid*  reg_oid, size_t reg_oid_len,
                              u_long*  it,
                              Netsnmp_Node_Handler*  subhandler)
{
...
int
NetSnmpAgent::netsnmp_register_long_scalar(const char* name,
                              const oid*  reg_oid, size_t reg_oid_len,
                              long*  it,
                              Netsnmp_Node_Handler*  subhandler)
{
...
int
NetSnmpAgent::netsnmp_register_read_only_long_scalar(const char* name,
                              const oid*  reg_oid, size_t reg_oid_len,
                              long*  it,
                              Netsnmp_Node_Handler*  subhandler)
{
...
int
NetSnmpAgent::netsnmp_register_int_scalar(const char* name,
                              const oid*  reg_oid, size_t reg_oid_len,
                              int*  it,
                              Netsnmp_Node_Handler*  subhandler)
{
...
int
NetSnmpAgent::netsnmp_register_read_only_int_scalar(const char* name,
                              const oid*  reg_oid, size_t reg_oid_len,
                              int*  it,
                              Netsnmp_Node_Handler*  subhandler)
{
...
int
NetSnmpAgent::netsnmp_register_read_only_counter32_scalar(const char* name,
                              const oid*  reg_oid, size_t reg_oid_len,
                              u_long*  it,
                              Netsnmp_Node_Handler*  subhandler)
{
