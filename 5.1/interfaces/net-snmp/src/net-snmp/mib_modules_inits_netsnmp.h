...
//  if (should_init("tcpTable")) init_tcpTable();
    ...
    //if (should_init("snmpQualnetTutorialMIB")) init_snmpQualnetTutorialMIB();
...
//#endif
#ifdef JNE_INTERFACE
    if (should_init("jtrsMiMIB")) init_jtrsMiMIB();
    if (should_init("jtrsMdlMIB")) init_jtrsMdlMIB();
    if (should_init("jtrsSiSAdapterMIB")) init_jtrsSiSAdapterMIB();
    if (should_init("jtrsWnwMIB")) init_jtrsWnwMIB();
    
    if (should_init("jtrsHmsMIB")) init_jtrsHms();
    if (should_init("hmsChannelMIB")) init_hmsChannel();
    if (should_init("hmsWfSrw10cStatusMIB")) init_hmsWfSrw10cStatus();
    if (should_init("hmsWfSrw10cStatMIB")) init_hmsWfSrw10cStat();
    if (should_init("hmsWfSrw10cStatMIB")) init_hmsWfSrw10cCtrl();
    if (should_init("hmsWfSrw10cStatMIB")) init_hmsWfSrw10cConfig();

    if (should_init("ittrSrwStatsMIB")) init_ittrSrwStats();
#endif
