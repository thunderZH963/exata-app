 ...
 */
#ifndef AGENT_HANDLER_H_NETSNMP
#define AGENT_HANDLER_H_NETSNMP
...
int netsnmp_call_handler_out(netsnmp_mib_handler* next_handler,
                    netsnmp_handler_registration* reginfo,
                    netsnmp_agent_request_info* reqinfo,
                    netsnmp_request_info* requests,
                    Node* node);

#endif /* AGENT_HANDLER_H_NETSNMP */
